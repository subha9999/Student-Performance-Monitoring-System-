            ...
            <div class="row">
                ...
                <div class="card bg-c-blue order-card">
                  <div class="card-block">
                    <h6 class="m-b-20"> <a href="Questions.php" style="text-decoration: none;color:white;">Add Question</a> </h6>
              ...
              <div class="col-md-6 col-lg-3">
                <div class="card bg-c-green order-card">
                  <div class="card-block">
                    <h6 class="m-b-20"><a href="view-question.php" style="text-decoration: none;color:white;">View Questions</a> </h6>
