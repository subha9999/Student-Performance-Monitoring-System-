				...
				<div class="row">
					...
					<div class="card bg-c-blue order-card">
					  <div class="card-block">
						<h6 class="m-b-20"> <a href="add_course_outline.php" style="text-decoration: none;color:white;">Add Course Outline</a> </h6>
				  ...
				  <div class="col-md-6 col-lg-3">
					<div class="card bg-c-green order-card">
					  <div class="card-block">
						<h6 class="m-b-20"><a href="view_course_outline.php" style="text-decoration: none;color:white;">View Course Outline</a> </h6>
				  ...
				  <div class="col-md-6 col-lg-3">
					<div class="card bg-c-green order-card">
					  <div class="card-block">
						<h6 class="m-b-20"><a href="create_course_outline.php" style="text-decoration: none;color:white;">Create Course Outline</a> </h6>
						<h2 class="text-right"><i class="fas fa-plus f-left"></i></h2>
					  </div>
					</div>
				  </div>
