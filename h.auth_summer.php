            ...
            <ul class="side-menu">
                ...
                <li>
                    ...
                    <ul class="side-dropdown">
					    ...
					    <li><a href="h.auth_autumn.html">Autumn</a></li>
                    </ul>
                </li>
            ...
            <div class="row">
                ...
                <div class="card bg-c-blue order-card">
                  <div class="card-block">
                    <h6 class="m-b-20"> <a href="h.auth_view_question.html" style="text-decoration: none;color:white;">Quiz</a> </h6>
              ...
              <div class="col-md-6 col-lg-3">
                <div class="card bg-c-green order-card">
                  <div class="card-block">
                    <h6 class="m-b-20"><a href="h.auth_view_question.html" style="text-decoration: none;color:white;">Mid-term</a> </h6>
                    <h2 class="text-right"><i class="fas fa-plus f-left"></i></h2>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6 col-lg-3">
                <div class="card bg-c-green order-card">
                  <div class="card-block">
                    <h6 class="m-b-20"><a href="h.auth_view_question.html" style="text-decoration: none;color:white;">Final-Term</a> </h6>
                    <h2 class="text-right"><i class="fas fa-plus f-left"></i></h2>
                  </div>
                </div>
              </div>
