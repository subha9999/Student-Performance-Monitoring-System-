		...
		<div class="container">
			<div class="panel panel-primary">
			  <div class="panel-heading">
				<h3 class="panel-title">PLO CO Mapping</h3>
			  </div><br><br>
            <form>
				...
				                                        <label for="co1">CO1 maps to</label>
					<input type="text" placeholder="Obtained Marks"><br><br>
					                                        <label for="co2">CO2 maps to</label>
					<input type="text" placeholder="Obtained Marks"><br><br>
					                                        <label for="co3">CO3 maps to</label>
					<input type="text" placeholder="Obtained Marks"><br><br>
					                                        <label for="co4">CO4 maps to</label>
					<input type="text" placeholder="Obtained Marks"><br><br>
