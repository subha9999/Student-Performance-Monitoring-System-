		...
		<div class="container">
			<div class="panel panel-primary">
			  <div class="panel-heading">
				<h3 class="panel-title">Evalution Data</h3>
			  </div><br>
            <form class="form-assessment">
                ...
                <select name="Course" id="courseid">
                    ...
                    <option value="course">CSE303</option>
                </select>
                          <label for="Course">Section:</label>
                <select name="section" id="courseid">
                    <option value="course">01</option>
                    <option value="course">02</option>
                    <option value="course">03</option>
                 </select>
				        <input type="text" name="username" id="Username"><br>
				              <label for="assessmentData">Number of Assessments:</label>
                <input type="text" name="assessmentData" id="assessmentData">
				<label for="">Number of Students:</label>
				<input type="text" name="username" id="Username">
                    <input type="button" value="Enter"><br><br>
				<form class="form-studentid">
					                            <input type="text" placeholder="Student ID"><br><br>
					                            <label for="Question1">Question 01</label>
					<input type="text" placeholder="Obtained Marks"><br><br>
					                            <label for="Question2">Question 02</label>
					<input type="text" placeholder="Obtained Marks"><br><br>
					                            <label for="">Question 03</label>
					<input type="text" placeholder="Obtained Marks"><br><br>
					                            <label for="">Question 04</label>
					<input type="text" placeholder="Obtained Marks"><br><br><br>
					                            <input type="text" placeholder="Student ID"><br><br>
					                            <label for="Question1">Question 01</label>
					<input type="text" placeholder="Obtained Marks"><br><br>
					                            <label for="Question2">Question 02</label>
